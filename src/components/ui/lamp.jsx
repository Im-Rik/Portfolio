...
export const LampContainer = ({ children, className }) => {
  return (
    <div className={cn("relative flex min-h-screen h-auto flex-col items-center justify-center overflow-hidden bg-slate-950 w-full z-0", className)}>
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0" style={{ top: "0rem" }}> // Default height for PC
        {/* Add responsive styles for mobile */}
        <style jsx>{`
          @media (max-width: 640px) {
            .relative.flex {
              top: calc(-50vh + 20rem) !important;
            }
          }
        `}</style>
        <motion.div
